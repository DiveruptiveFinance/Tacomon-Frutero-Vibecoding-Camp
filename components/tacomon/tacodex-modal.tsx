  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxHeight: '90vh', overflowY: 'auto', backgroundColor: 'var(--background)', boxShadow: '0 8px 32px rgba(0,0,0,0.6)' }}
        onClick={(e) => e.stopPropagation()}
      >
        <p className="title" style={{ fontSize: 'var(--text-sm)', backgroundColor: 'var(--background)' }}>
          📖 Tacodex
        </p>
