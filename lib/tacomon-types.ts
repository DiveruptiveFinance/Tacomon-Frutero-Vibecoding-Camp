...
export const SPECIALTY_CONFIG: Record<Specialty, SpecialtyConfig> = {
  ...
  champinones: {
    ...
    sprite: '/sprites/champinones.png',
...
export const TACO_CONFIG = {
  vegetariano: {
    ...
    sprite: '/sprites/taco-vegetariano.png',
  ...
  mariscos: {
    ...
    sprite: '/sprites/taco-mariscos.png',
